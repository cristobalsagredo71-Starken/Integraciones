...
app_js_path = r"C:\Users\cristobal.sagredo\Desktop\Obsidian\10 Proyectos\maestro-integraciones\app.js"
kam_js_path = r"C:\Users\cristobal.sagredo\Desktop\Obsidian\10 Proyectos\maestro-integraciones\kam.js"

with open(app_js_path, 'r', encoding='utf-8') as f:
    js = f.read()

# We need the Supabase fetching part, but we will rewrite the render logic.
# Let's extract Supabase init and fetchInitiatives
fetch_logic = """
...
with open(kam_js_path, 'w', encoding='utf-8') as f:
    f.write(fetch_logic)
print("kam.js generated successfully")
